...
import { GraduationCap, Mail, Lock, User as UserIcon, BookOpen, AlertCircle, Hash } from 'lucide-react';
...
const Signup: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const success = await signup(formData.name, formData.email, formData.password, formData.program, formData.carne);
      if (success) {
        navigate('/');
      } else {
        setError('Este correo electrónico o número de carné ya está registrado. Por favor usa otros datos.');
      }
    } catch (err) {
